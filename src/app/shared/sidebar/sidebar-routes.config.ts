...
export const ROUTESHOMEDX: RouteInfo[] = [
    ...
    { path: 'thefoundation', title: 'f29.The Foundation', icon: 'fa fa-building', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: true, submenu: [] },
